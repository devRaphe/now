...
class Validators {
  static ValidatorFn<String, String> tryAlpha({String error, String label = "Field"}) {
    return (String value) {
      if (value.isEmpty) {
  ...
  static ValidatorFn<String, String> tryDouble({String error, String label = "Field"}) {
    return (String value) {
  ...
  static ValidatorFn<String, String> tryInt({String error, String label = "Field"}) {
    return (String value) {
      if (value == null || value.isEmpty) {
        return error ?? '$label is required.';
      }
  ...
  static ValidatorFn<String, String> tryEmail({String error, String label = "Email"}) {
    return (String value) {
      if (value.isEmpty) {
        return error ?? '$label is required.';
      }
  ...
  static ValidatorFn<String, String> tryPhone({String error, String label = "Phone number"}) {
    return (String value) {
      if (value.isEmpty) {
        return error ?? '$label is required.';
      }
  ...
  static ValidatorFn<List<dynamic>, String> tryList({String error, String label = "Field"}) {
  ...
  static ValidatorFn<String, String> tryMeter(String meterNumber, [String error]) {
    return (String value) {
      return Validators.tryString()(value) ??
  ...
  static ValidatorFn<String, String> tryLength({int min = 1, int max = 99, String label = "Field", String error}) {
    return (String value) {
      if (value == null || value.isEmpty || value.trim().isEmpty) {
        return error ?? '$label is required.';
      }
      if (value.length < min || value.length > max) {
        return error ?? '$label should be less than $max characters and greater than $min characters.';
      }
      return null;
    };
  }

  static ValidatorFn<String, String> tryString({String error, String label = "Field"}) {
    return (String value) {
      if (value == null || value.isEmpty || value.trim().isEmpty) {
        return error ?? '$label is required.';
      }
  ...
  static ValidatorFn<DateTime, String> tryDate({String error, DateTime min, DateTime max}) {
